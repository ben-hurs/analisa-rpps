...
##
#cotas_rpps = pd.merge(filtro_municipio1, cotas, how='inner', left_on = 'ID ATIVO', right_on = 'CNPJ' )
...
#retorno_anual = round(retorno.mean() * 250,2)
